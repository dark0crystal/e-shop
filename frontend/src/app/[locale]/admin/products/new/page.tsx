...
const variations = [
  {
    id: 'v1',
    categoryId: 'c2c2c2c2-c2c2-c2c2-c2c2-c2c2c2c2c2c2', // Clothing
    name: 'Size',
    options: [
      { id: 'o1', value: 'S' },
      { id: 'o2', value: 'M' },
...
// categories
  ...
  //variations
  const selectedCategoryId = watch('childCategory') || watch('parentCategory');
  ...
  const onSubmit = async (data: ItemFormFields) => {
    const selectedOptionIds = Object.values(data.variationOptionIds || {});
    const payload = {
      ...data,
      variationOptionIds: selectedOptionIds,
    };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div key={variation.id}>
              ...
              <select
                {...register(`variationOptionIds.${variation.id}` as const)}
                className="w-full border border-gray-300 rounded-lg px-4 py-2"
              >
